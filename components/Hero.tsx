...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-screen flex flex-col justify-center items-center text-center px-4 sm:px-6 lg:px-8 overflow-hidden"
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-8 sm:mt-10">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="w-full sm:w-auto bg-white hover:bg-gray-100 text-blue-900 font-semibold px-8 py-4 rounded-full text-lg text-lg shadow-xl transition-all flex items-center justify-center gap-2"
            >
